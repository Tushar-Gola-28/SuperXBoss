...
export function NotificationPage() {
    ...
    return (
        <Box>
            <SectionHeader heading="Notifications" icon="https://ticketsque-public.s3.ap-south-1.amazonaws.com/icons/Events.svg" />
            <Stack gap={1} sx={{ mb: 2 }} direction="row" justifyContent={{ xs: "flex-end       ", md: "space-between" }} alignItems="center" flexWrap="wrap">
                ...
                />
                <Stack>
                    <Button variant="contained" startIcon={<AddIcon />} onClick={() => navigate(`${urls.NOTIFICATION_HANDLER}/`)} >Create Notification</Button>
                </Stack>
            </Stack>
            <CustomTable
                rows={data?.rows}
